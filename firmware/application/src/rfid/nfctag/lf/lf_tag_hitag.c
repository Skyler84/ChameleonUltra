...
int lf_tag_hitag_data_loadcb(tag_specific_type_t type, tag_data_buffer_t *buffer){ return 0; }
int lf_tag_hitag_data_savecb(tag_specific_type_t type, tag_data_buffer_t *buffer){ return 0; }
bool lf_tag_hitag_data_factory(uint8_t slot, tag_specific_type_t tag_type){ return false; }
